...
3. **Set the repository secrets** your `auth.method` needs, plus the release
   ...
   are decided; without it that one step is dispatched by hand. Both are
   already set on this repository — see
   [docs/CONFIGURING.md](docs/CONFIGURING.md#the-github-app-the-auto-continuation-needs).
